  ...
  <div class="content-wrap">
    <div class="container chat-in-box" id="List">
      <p style="padding: 10px 0 10px 20px;font-size: 16px;">
        <router-link to="/otcorder" style="color:#3399ff;">{{$t('otc.myorder')}}</router-link> ><span style="font-size:14px;">{{$t('otc.chat.orderDetails')}}</span>
      </p>
      <Row class="chat-in">
        <Col span="4">
...
/deep/ .chat-in-box .chat-in .chat-right .chat-right-in p[data-v-5349a3cd]{
  font-size:14px !important;
}
/deep/ .leftmenu[data-v-5349a3cd]{
  font-size:12px;
  color:red;
}
/deep/ .chat-in .ivu-col.ivu-col-span-4 .ivu-poptip-popper{
  margin-top: 35px;
}
/deep/ .chat-in .ivu-col.ivu-col-span-4 .ivu-poptip-title{
  display: none;
}
.pop-tel{
  position: absolute;
