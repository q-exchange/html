...
.entrusthistory .ivu-form-item{
  margin-bottom: 0px;
}
/deep/ .ivu-form-item-content .ivu-select .ivu-select-selection i{
//   margin-top: 0.5px;
}
        ...
        <div class="historycontent">
            <div class="til">
                ...
                <FormItem :label-width="locale == 'en' ? 144 : 60 " :label="$t('historyAndCu.stEnTime')">
                    <DatePicker type="daterange" v-model="formItem.date" style="width:200px;"></DatePicker>
                </FormItem>
            ...
            <Table class="table escapeTables" :no-data-text="$t('common.nodata')" :columns="columns" :data="orders" :loading="loading"></Table>
