    ...
    <div class="nav-right">
      <div class="bill_box_address">
        ...
        <section class="trade-group merchant-top">
          ...
          <span>
            <router-link to="/uc/coin">资产&nbsp;&nbsp;&nbsp;></router-link>
          </span>
          <span class="tips-word1">{{$t('uc.finance.withdraw.addressmanager')}}</span>
        </section>
        <div class="table-inner">
          <div style="background:#fff;margin-bottom:20px;padding-top:20px;">
            ...
            <div class="btnbox">
              <Button id="addrSubmit" @click='addAddr' size="large" style="width:86px;color:#fff;background:#3399ff;border:1px solid #3399ff;">{{$t('uc.finance.withdraw.add')}}</Button>
            </div>
          </div>
          ...
          <div class="action-content">
            <div class="action-body">
              ...
              <div class="order-table">
                <Table :columns="tableColumnsRecharge" :data="dataRecharge" :disabled-hover="true" class="escapeTables"></Table>
...
.nav-rights {
  .nav-right {
    .bill_box_address {
      ...
      //         }
      //       }
      //       /deep/ .ivu-select.ivu-select-visible.ivu-select-single {
      //         .ivu-select-selection {
      //           border-color: @primary-custom;
      ...
      //         }
      //       }
      //       /deep/ .ivu-select-dropdown .ivu-select-item {
      //         padding: 6px 16px;
      //         &:hover {
      //           background: #fff;
      ...
      //           color: @primary-custom;
      //         }
      //         /deep/ li.ivu-select-item.ivu-select-item-selected {
      //           background: #fff;
      //           color: #495060;
      //           &:hover {
      //             color: @primary-custom;
