...
.chat-container-box .user-chat-box .user-content-box .chat-info .user-desc .icon {
    height: 0;
    width: 0;
    border: 8px @border-style_solid transparent;
    border-right: 14px @border-style_solid #f1f1f4;
    position: absolute;
    top: 6px;
    left: -20px;
}
...
.chat-container-box .user-chat-box .user-content-box .chat-info .self-desc .icon {
    ...
    width: 0;
    border: 8px @border-style_solid transparent;
    border-left: 14px @border-style_solid @primary-custom;
    position: absolute;
    top: 6px;
    right: -18px;
    left: unset;
...
.chat-in-box .chat-in .chat-line .send-msg-box input {
    height: 60px;
    border: @border-width_primary @border-style_solid transparent;
    border-left: none;
    background-color: transparent;
    padding: 10px;
    outline: none;
